    ...
    <div className="min-h-screen flex bg-gray-50">
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-slate-900 to-slate-700 items-center justify-center p-12">
        <div className="max-w-sm text-white">
          <div className="w-14 h-14 bg-white/10 rounded-2xl flex items-center justify-center mb-8"><Bolt className="w-8 h-8 text-white" /></div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          <div className="mb-10">
            <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center mb-6 lg:hidden border border-gray-200"><Bolt className="w-5 h-5 text-slate-700" /></div>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-slate-900/20 focus:border-slate-900 transition-colors"
